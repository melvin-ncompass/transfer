...
import { setRawFile, setUploadedFile } from "../CSVSlice";
import CSVStats from "./CSVStats";
import FileDropZone from "./FileDropZone";

import Papa from "papaparse";
import { PrimaryButton } from "../../../../../../components/atom/button";
import { useGetDemoCSVMutation } from "../api/contactsImport.api";
import { Snackbar } from "../../../../../../components/atom/snackbar";
export interface DataRow {
  [key: string]: string | number;
}
function UploadCSV() {
  const [getDemoCSV, { isLoading }] = useGetDemoCSVMutation();
  const handleDownload = async () => {
    try {
      ...
      link.href = url;
      link.download = "ContactSample.csv";
