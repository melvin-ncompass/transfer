...
import { setError, setPfp } from "../profileSlice";
import { useUploadProfilePicMutation } from "../../api/profile.api";
interface ImageCropperProps {
  onCropComplete: (croppedImage: string) => void;
}
export const ImageCropper = ({ onCropComplete }: ImageCropperProps) => {
  ...
  const onSelectFile = (file: File |File[]| null) => {
    ...
    reader.addEventListener("error", (error) => {
      ...
      dispatch(setError("File cannot be uploaded due to security restrictions."));
            ...
            <Box flex={1} justifyContent={"center"} display={"flex"}>
              <canvas
                ...
                style={{
                  ...
                  border: "1px solid #ccc",
                  objectFit: "cover",
                  width: "45vh", // ensure a valid number
                  height: "45vh", // same as width for circle
                  overflow: "hidden",
                }}
              />
            </Box>
