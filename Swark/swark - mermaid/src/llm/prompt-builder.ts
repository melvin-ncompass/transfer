...
export class PromptBuilder {
    ...
    public static getDetailedSystemPrompt(): vscode.LanguageModelChatMessage {
        return vscode.LanguageModelChatMessage.User(
            ...
            The diagram must show comprehensive system components, their relationships, data flows, and include specific implementation details.

            ===========================
            📌 Reference Example (Clean Detailed Flowchart Syntax)
            ===========================
            flowchart TD
                %% External Resources
                DB[(Database)]
            ...
            4. Use **simple, clean node shapes**:
               - **[Component Name]** for regular components/modules/controllers
               - **{Decision Point?}** for decision points ONLY when showing specific logic flows
               - **[(Database)]** for databases/storage
               - **[[Config/Utils]]** for configuration/utilities
               - **[External Service]** for external APIs/services
            5. **CRITICAL**: Keep all connections **outside subgraph blocks** - never define arrows inside subgraphs.
            6. Use **clear, readable names** without special characters in node IDs.
            7. Show **detailed workflows and data paths** including middleware chains.
            8. Include **error handling components** and **validation layers**.  
            9. Include **authentication/authorization flows** and **middleware stacks**.  
            10. Display **configuration management** and **environment dependencies**.  
            11. Show **caching layers**, **database connections**, and **external integrations**.
            12. Focus on **implementation-level architecture** showing actual code organization.  
            13. Always begin with \`flowchart TD\`.  
            14. **Group related components** in logical subgraphs (by layer or functionality).
            15. Use **consistent naming** - same component should have same name throughout.
            16. **Avoid complex nested flows** - focus on component relationships.
