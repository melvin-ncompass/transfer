...
export async function showDiagram(uri: vscode.Uri): Promise<void> {
    try {
        ...
        try {
            ...
            console.log("Preview to side failed, trying regular preview:", previewError);
            ...
            try {
                ...
                // Show notification about Mermaid extension
                const action = await vscode.window.showInformationMessage(
                    "Diagram generated! For better Mermaid rendering, install 'Markdown Preview Mermaid Support' extension.",
                    "Install Extension",
                    "Dismiss"
                );
