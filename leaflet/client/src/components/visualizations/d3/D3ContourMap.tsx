...
const D3ContourMap = ({ data }: D3ContourMapProps) => {
  ...
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      // Add contour visualization using circles with varying colors
      data.forEach((point) => {
        const el = document.createElement('div');
        el.className = 'd3-contour-point';
        el.style.width = '25px';
      ...
      legendEl.innerHTML = `
        <div style="font-size: 12px; font-weight: bold; margin-bottom: 5px;">Contour Values</div>
