import { PermissionSwagger } from './swagger/permissions.swagger';
import {
  Controller,
  Get,
  Post,
...
// import { SwaggerEndpoint } from 'src/utils/swagger/custom-swagger';
...
export class PermissionController {
  ...
  @Post()
  @SwaggerEndpoint(PermissionSwagger,'CREATE_PERMISSION')
  ...
  @Get()
  @SwaggerEndpoint(PermissionSwagger,'GET_PERMISSIONS')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions(PermissionEnum.MANAGE_ROLES)
  async findAll() {
    try {
  ...
  @Put(':id')
  @SwaggerEndpoint(PermissionSwagger,'UPDATE_PERMISSION')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions(PermissionEnum.MANAGE_ROLES)
  ...
  @Delete(':id')
  @SwaggerEndpoint(PermissionSwagger,'DELETE_PERMISSION')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions(PermissionEnum.MANAGE_ROLES)
  ...
  @Post(':id/restore')
  @SwaggerEndpoint(PermissionSwagger,'RESTORE_PERMISSION')
  ...
  @Delete(':id/hard')
  @SwaggerEndpoint(PermissionSwagger,'HARD_DELETE_PERMISSION')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions(PermissionEnum.MANAGE_ROLES)
