import { InvitesSwagger } from './swagger/invites.swagger';
import {
  Controller,
  Get,
  Post,
...
export class InvitesController {
  ...
  @Post('invite')
  @SwaggerEndpoint(InvitesSwagger, 'INVITE_USER')
  ...
  // only admin and super admin
  @Get('invites')
  @SwaggerEndpoint(InvitesSwagger, 'GET_INVITES')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions(PermissionEnum.MANAGE_USERS)
  async getAllInvites() {
    try {
  ...
  @Post('invite/check')
  @SwaggerEndpoint(InvitesSwagger, 'CHECK_INVITE')
  ...
  @Post('invite/accept')
  @SwaggerEndpoint(InvitesSwagger, 'ACCEPT_INVITE')
  ...
  @Post('invite/onboard')
  @SwaggerEndpoint(InvitesSwagger, 'ONBOARD')
  ...
  @Post('reinvite')
  @SwaggerEndpoint(InvitesSwagger, 'REINVITE')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions(PermissionEnum.MANAGE_USERS)
