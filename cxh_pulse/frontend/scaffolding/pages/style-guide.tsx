    ...
    <Card>
      ...
      {/* Form content here */}
                                ...
                                <Box id="snackbars" sx={{ mb: 5 }}>
                                    ...
                                    <ComponentSection
                                        title="Progress Snackbar (Recommended)"
                                        description="Toast notifications with dynamic progress bar based on message length"
                                        code={`import { ProgressSnackbar } from '../../src/components/snackbar';
...
setSnackbar({
  open: true,
  message: "Esther's role has been changed from Super Admin to Manager",
  severity: 'success',
});
...
setSnackbar({
  open: true,
  message: "Failed to update John's profile. Please try again.",
  severity: 'error',
});

// Features:
// - Progress bar that grows from 0% to 100%
// - Duration auto-calculated based on message word count
// - Color matches severity (green/red/yellow/blue)
// - Base: 2s + 350ms per word (min: 2.5s, max: 8s)`}
                                    >
                                        <Stack spacing={2}>
                                            <Box>
                                                <Typography variant="subtitle2" sx={{ mb: 2 }}>
