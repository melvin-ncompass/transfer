...
type DatePickerPopoverProps = {
    ...
    // The other date (start or end) to prevent selecting same month/year
    otherDate?: { year: number; month: number };
...
export function DatePickerPopover({
    ...
    const getMonthDisabled = (m: number) => {
        ...
        // Prevent selecting same month and year as the other date
        // Check: if (currently selected year + this month) would match otherDate
        if (otherDate && year === otherDate.year && m === otherDate.month) return true;
    ...
    const getYearDisabled = (y: number) => {
        ...
        // Prevent selecting same year and month as the other date
        // Check: if (this year + currently selected month) would match otherDate
        if (otherDate && y === otherDate.year && month === otherDate.month) return true;
