...
export const healthApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        getDkhisWards: builder.query<any, void>({
            query: () => ({
                url: 'visualizationV1/wardSubCounty',
            }),
        ...
        >({
            query: (params) => ({
                ...
                params: {
                    ...
                    ...(params.subcounty && { subcountyId: params.subcounty }),
                },
            }),
            transformResponse: (response: any) => response.data || [],
        }),
        ...
        getDkhsWardsCounties: builder.query<any, any>({
            query: (params) => ({
                url: 'visualizationV1/kajiadoWards',
                params: {
        ...
        getKhisFacility: builder.query<any, any>({
            query: (params) => ({
                url: '/visualizationV1/kajiado/facility',
                params: {
        ...
        >({
            query: ({ indicatorId, wardId, subCountyId, countyId }) => ({
