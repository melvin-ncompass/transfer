...
*/
const CHART_TITLE = 'Heatmap of Monthly Temperature (°C)';

export function MonthlyTemperatureHeatmap({ data, filterInfo, dateRange, isLoading }: MonthlyTemperatureHeatmapProps) {
  ...
  const getSeriesData = useCallback(() => ({
    ...
    series: heatmapData.map(s => ({
      name: getMonthName(s.name), // Convert month number to name for CSV
      data: s.data
    })),
