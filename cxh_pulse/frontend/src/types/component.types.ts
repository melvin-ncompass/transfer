...
export type ChoroplethMapProps = {
  ...
  onSelectionModeChange?: (mode: SelectionMode.SUBCOUNTY | SelectionMode.WARD) => void;
  ...
  mapDateRange: { from : Date; to: Date };
  hasPlayed: boolean;
  onResetMap?: () => void;
};
...
export type ResetButtonProps = {
  ...
  // Props for zooming to selected feature
  selectedWard?: string;
  selectedCounty?: string;
  selectionMode?: 'subcounty' | 'ward';
  wardsGeoJSON?: GeoJSON.FeatureCollection;
...
import { SelectionMode } from 'src/sections/dashboard/overview/overview-view';
