...
export const roleApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
     ...
     */
    getRoles: builder.query<RolesApiResponse, GetAllRolesParams | void>({
      query: (params) => {
        const queryParams = new URLSearchParams();
        if (params?.isDetailed) queryParams.append('isDetailed', params.isDetailed.toString());
      ...
      transformResponse: (response: RolesApiResponse): RolesApiResponse => ({
        data: response.data,
