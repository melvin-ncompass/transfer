...
```bash
git clone -b FE/prod --recursive https://github.com/datakind/climate-health-pulse-project.git
cd  climate-health-pulse-project
```

### Method 2: Clone without Submodules (then initialize separately)
...
3. **Access the application:**
   ...
   Open your browser and navigate to `http://localhost:3039` (or the port specified in your `.env` file).
