...
const MuiButton: Components<Theme>['MuiButton'] = {
  ...
  styleOverrides: {
    root: ({ theme }) => ({
      ...
      '&:focus-visible': {
        outline: `3px solid ${varAlpha(theme.vars.palette.primary.mainChannel, 0.4)}`,
        outlineOffset: '2px',
      },
    }),
    contained: ({ theme }) => ({
  ...
  styleOverrides: {
    root: ({ theme }) => ({
      ...
      borderRadius: (() => {
        ...
        if (typeof br === 'number') return br * 2;
        const brStr = String(br);
        if (brStr.endsWith('px')) return `${parseFloat(brStr) * 2}px`;
        return br;
      })(),
    }),
  },
  ...
  styleOverrides: {
    root: ({ theme }) => ({
      ...
      '& .MuiOutlinedInput-root': {
        '& fieldset': {
          borderColor: theme.palette.grey[400], // default border
        },
        '&:hover fieldset': {
          borderColor: theme.palette.primary.main, // hover border
        },
        '&.Mui-focused fieldset': {
          borderColor: theme.palette.secondary.main, // focused border
        },
      },
    }),
  },
...
const MuiIconButton: Components<Theme>['MuiIconButton'] = {
  styleOverrides: {
    root: ({ theme }) => ({
      ...
      '&:focus-visible': {
        outline: `2px solid ${varAlpha(theme.vars.palette.primary.mainChannel, 0.4)}`,
        outlineOffset: '2px',
      },
    }),
  },
  ...
  styleOverrides: {
    ...
    switchBase: ({ theme }) => ({
      ...
      '&.Mui-focusVisible .MuiSwitch-thumb': {
        border: `6px solid ${theme.vars.palette.common.white}`,
      },
    }),
    thumb: {
    ...
    track: ({ theme }) => ({
      borderRadius: 26 / 2,
      backgroundColor: varAlpha(theme.vars.palette.grey['500Channel'], 0.38),
      opacity: 1,
