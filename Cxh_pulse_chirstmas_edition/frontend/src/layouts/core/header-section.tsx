...
import { headerSectionStyles } from '../../styles/layouts/header-section.styles';
...
export function HeaderSection({
  ...
  return (
    <HeaderRoot
      ...
      sx={[
        (theme) => headerSectionStyles.headerRoot(theme, isOffset),
...
const HeaderRoot = styled(AppBar, {
  ...
  const bgStyles: CSSObject = {
    ...
    backgroundColor:
      'var(--layout-header-surface, var(--brand-header-surface, var(--brand-surface)))',
    ...(isOffset && {
      opacity: 1,
      visibility: 'visible',
    }),
  ...
  return {
    // default header text color comes from layout/header vars, falling back to brand text
    '--color': 'var(--layout-header-text, var(--brand-header-text, var(--brand-text)))',
    boxShadow: 'none',
