...
import { Box, Typography, Card, CardContent, Stack, Slider } from '@mui/material';
...
export function ConfigView() {
    ...
    const [temperatureThreshold, setTemperatureThreshold] = useState(28.5);
    const [precipitationThreshold, setPrecipitationThreshold] = useState(170);
    ...
    return (
        <Box sx={configViewStyles.container}>
            ...
            >
                <Alert onClose={handleSnackbarClose} severity={snackbar.severity} sx={configViewStyles.snackbarAlert}>
                    {snackbar.message}
                </Alert>
            </Snackbar>
        </Box>
