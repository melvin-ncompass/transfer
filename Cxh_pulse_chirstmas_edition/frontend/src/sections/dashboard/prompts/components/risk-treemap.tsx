...
import { PRIORITY_LEVELS, type RiskCategory } from './constants';
 ...
 */
export function RiskTreemap({ category, title }: RiskTreemapProps) {
    const {
        data = [],
        isLoading,
        isFetching,
    ...
    const { selectedCategory, selectedPriority, setCategory, setPriority } = usePromptFilter();
    ...
    const chartOptions = useChart({
        ...
        tooltip: {
            ...
            custom: ({ seriesIndex, dataPointIndex, w }: any) => {
                ...
                return `
                    <div style="padding: 10px; background: rgba(0, 0, 0, 0.8); border-radius: 4px; color: white; font-size: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.3);">
