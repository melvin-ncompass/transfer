...
type PromptFilterContextType = {
    ...
    setPriority: (priority: PriorityLevel | null) => void;
    clearFilters: () => void;
...
export function PromptFilterProvider({ children }: PromptFilterProviderProps) {
    ...
    const setPriority = useCallback((priority: PriorityLevel | null) => {
        // Toggle: if clicking the same priority, clear it
    ...
    const hasActiveFilters = selectedCategory !== null || selectedPriority !== null;
