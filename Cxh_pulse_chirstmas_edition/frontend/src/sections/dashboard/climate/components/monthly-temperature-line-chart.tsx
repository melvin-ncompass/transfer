 ...
 */
export function MonthlyTemperatureLineChart({ data, onTitleClick, isTitleClickable = false }: MonthlyTemperatureLineChartProps) {
    // Fetch threshold configuration from API
    // const { data: configuration } = useGetConfigurationQuery();
    // const temperatureThreshold = configuration?.config?.temperatureThreshold;
    ...
    return (
        <Card sx={monthlyTemperatureLineChartStyles.card}>
            ...
            {!hasValidData ? (
                <Box sx={monthlyTemperatureLineChartStyles.noDataContainer}>
