...
import { Alert, Snackbar, LinearProgress, useTheme, Stack } from '@mui/material';
...
export function SignUpView() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/?showAuth=true&authTab=sign-in', { replace: true });
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* dont use router link here */}
          <Link to="/?showAuth=true&authTab=sign-in" style={{ marginLeft: 6, cursor: 'pointer' }}>
            Sign in
          </Link>
        </Typography>
      </Box>
