...
-   🧜‍♀️ **D2**: Swark generates diagrams in D2, a modern diagram scripting language. You can edit and refine the diagrams as needed.
...
-   **[Optional] D2 Extension**: To preview the diagram in VS Code you can install the [D2](https://marketplace.visualstudio.com/items?itemName=terrastruct.d2) extension. Alternatively, you can use the provided links to open it in D2 Playground (free) or TerraStruct (requires account).
...
-   **Diagram file**: Contains the diagram's D2 code. This file is presented when you run Swark.\
...
4. **Diagram Preview**: Upon a successful response, the diagram is presented. This is done by creating a markdown file that includes the diagram in [D2](https://d2lang.com/) syntax and previewing it.

### Code Access and File Sharing

It's important to note that source code is **only shared with GitHub Copilot**, and with no other external APIs or providers.## Extension Settings
...
| `swark.fixD2Cycles` | (Deprecated - not needed for D2) Automatically fix cycles in the generated diagram to prevent rendering failures.                                                 |
