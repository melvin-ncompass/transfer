...
<p align="center">
  <b>Automatic Eraser Architecture Diagrams from Code</b><br />
...
Swark Eraser is a VS Code extension that allows creating architecture diagrams from code automatically using large language models (LLMs).\
Swark Eraser is **directly integrated with GitHub Copilot**, and requires no authentication or API key.
...
-   🎨 **Eraser.io Format**: Swark generates diagrams in Eraser.io format, allowing you to create interactive, professional architecture diagrams that can be edited online at [app.eraser.io](https://app.eraser.io/).
...
-   **[Optional] Eraser.io Account**: While not required, creating a free account at [app.eraser.io](https://app.eraser.io/) allows you to save and share your diagrams online.

## Installation

Simply install Swark Eraser via the [VS Code Extension Marketplace](https://marketplace.visualstudio.com/items?itemName=swark.swark-eraser).

## How to Use

1. In VS Code, open the [Command Palette](https://code.visualstudio.com/docs/getstarted/userinterface#_command-palette) and run: **Swark Eraser: Create Architecture Diagram**.\
...
-   **Diagram file**: Contains the diagram's Eraser.io code. This file is presented when you run Swark.\
...
4. **Diagram Preview**: Upon a successful response, the diagram is presented. This is done by creating a markdown file that includes the diagram in [Eraser.io](https://app.eraser.io/) syntax and previewing it.
...
| Setting                          | Description                                                                                                                              |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `swark.eraser.maxFiles`          | Max number of files to read.<br>The number of files read is also affected by the LLM max token limit.                                    |
| `swark.eraser.fileExtensions`    | List of file extensions to include in search.                                                                                            |
| `swark.eraser.excludePatterns`   | List of glob patterns to exclude from file search.<br>Defaults include: `**/.*` for hidden files, `**/node_modules/**` for node modules. |
| `swark.eraser.languageModel`     | Language model to use for diagram generation.                                                                                            |
