...
//     const filteredFiles = this.applyFileFiltering(
//       metadata.fileList,
//       regexPatterns,
...
//       for (const excludePattern of [
//         // ...regexPatterns.fileExclusion,
//         "**/.*",
//         "**/.*/*",
//         "**/node_modules/**",
//       ]) {
...
//       (sum, file) => sum + this.estimateTokens(file.filteredContent),
//       0
//     );

//     const finalTokens = processedFiles.reduce(
//       (sum, file) => sum + file.finalTokens,
//       0
//     );
