        ...
        <Card sx={{ p: 4, bgcolor: '#2a2a2a', color: 'white' }}>
          <CardContent sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="caption" display="block" sx={{ mt: 1 }}>
              This may take 10-30 seconds while our AI processes your code structure
            </Typography>
          </CardContent>
        </Card>
      </Box>
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        {/* Enhanced Sidebar - Always Visible for Debugging */}
        <Paper elevation={8} sx={{ 
          width: 380,
          minWidth: 380, // Ensure minimum width
          maxWidth: 380, // Ensure maximum width  
          bgcolor: '#1a1a2e',
          color: '#fff',
